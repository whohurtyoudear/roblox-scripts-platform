  ...
  return (
    ...
    >
      <div className="bg-[#1e293b] rounded-xl max-w-4xl w-full modal-animation relative">
        <button 
          className="absolute top-4 right-4 text-[#94a3b8] hover:text-white text-2xl"
          onClick={onClose}
        >
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="text-white mb-6 leading-relaxed">
            ...
            <h3 className="font-semibold text-lg mb-2 text-primary">Game Type:</h3>
            <p className="mb-4">{script.gameType}</p>
          ...
          <div className="relative mb-6">
            ...
            <button 
              className="absolute top-3 right-3 bg-[rgba(79,70,229,0.2)] text-[#a5b4fc] py-1 px-3 rounded hover:bg-[rgba(79,70,229,0.4)] transition-colors"
              onClick={handleCopy}
            >
              <i className="far fa-copy mr-1"></i> Copy Code
            </button>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            >
              <i className="fab fa-discord"></i> Join Discord for Support
            </a>
